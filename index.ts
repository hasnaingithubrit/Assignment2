...
let f:number=500;
let b:number=445;
let percentage:number=(b/f)*100;
console.log(`${percentage}%`);

//  Write a program that converts given number of days in to weeks and days such as 17 days = 2 weeks and 3 days.//

let totalDays:number=17;
let weeks:number|string=(totalDays/7);
let remainingDays:number|string =totalDays%7;
...
let discount2:number=price/100*5;
if(price>=100){
...
let dividedNumber:number= 5;
let divided3:number=dividedNumber%3;
let divided5:number=dividedNumber%5;
...
let givenYear:any = prompt("Enter a number");
let year: number = 365;
let LeapYear: number = 366;
if (year % 4) {
